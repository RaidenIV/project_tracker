...
class AppState {
    constructor() {
        ...
        // Currently logged-in user  { id, email, username }
    ...
    setHideCompletedTasks(hide) { this.hideCompletedTasks = hide; }
    ...
    setControlPanelOpen(isOpen) { this.controlPanelOpen = isOpen; }
