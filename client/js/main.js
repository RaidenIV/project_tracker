...
function suppressClickAfterMovableTabDrag(event) {
    ...
    // Only suppress the synthetic click generated by releasing the tab that was
    // just dragged. Clicking another tab after reordering must switch tabs
    // immediately, including in the project modal.
    if (!__movableTabSuppressKey || targetKey !== __movableTabSuppressKey || dx > 12 || dy > 12) {
